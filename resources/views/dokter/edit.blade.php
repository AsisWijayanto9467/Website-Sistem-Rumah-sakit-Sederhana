...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('dokter.update', $dokter->id ) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                <!-- Notifikasi -->
                @if(session('success'))
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $dokter->user->email ?? '') }}"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="poliklinik_id" name="poliklinik_id" 
                                ...
                                <option value="{{ $poliklinik->id }}" {{ old('poliklinik_id', $dokter->poliklinik->id) == $poliklinik->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" id="lama_pengalaman" name="lama_pengalaman" value="{{ old('lama_pengalaman', $dokter->lama_pengalaman) }}"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                        ...
                        <div>
                            ...
                            <input type="text" id="nomor_telpon" name="nomor_telpon" value="{{ old('nomor_telpon', $dokter->nomor_telpon) }}"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="pendidikan" name="pendidikan" rows="3"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            placeholder="Masukkan riwayat pendidikan (contoh: S1 Kedokteran Universitas Indonesia, Spesialis Jantung)">{{ old('pendidikan', $dokter->pendidikan) }}</textarea>
                    @error('pendidikan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(function() {
                ...
                if (pasienDropdown) {
                    ...
                    const dataPasienLink = pasienDropdown.querySelector('.submenu-item[data-submenu="data-dokter"]');
                ...
                sessionStorage.setItem('activeMenuValue', 'data-dokter');
